...
class BuyConfirmPopup extends StatefulWidget {
  const BuyConfirmPopup({super.key});

  @override
  State<BuyConfirmPopup> createState() => _BuyConfirmPopupState();
}

class _BuyConfirmPopupState extends State<BuyConfirmPopup> {
  @override
  void initState() {
                      ...
                      child: Stack(
                        children: [
                          Container(
                            ...
                            height: isIphone ? screenHeight * 0.52 : screenHeight * 0.4,
                            ...
                            child: Column(
                              children: [
                                ...
                                Text("Are you sure You Want To \nBuy This Product ?",
                                  ...
                                  style :TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize:(isIphone)?14: 24,color: Color.fromRGBO(
                                      241, 241, 241, 1.0), ),
                                ),
                              ],
                            ),
  ...
  Widget topAvatarWithText({
    ...
    return Padding(
      padding: EdgeInsets.only(left: (screenWidth * (0.0)) / 2,),
      child: Row(
          ...
          children: [
            ...
            Text(translationManager.translate("txtSpecial").toUpperCase(),
              ...
              style :TextStyle(
                  ...
                  fontSize:(isIphone)?12: 20,color: Color.fromRGBO(
                  121, 121, 121, 1.0) ),),
